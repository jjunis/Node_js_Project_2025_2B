...
class BattleServer{
    ...
    handleMesssage(playerId, data)
    {
        ...
        switch (data.type)
        {
            ...
            default :
                console(`알 수 없는 메세지 타입 : ${data.type}`);
        }
    }
    ...
    startBattle(player1Id, player2Id)
    {
        ...
        const battle = {
            ...
            turnCount : 1,
            player1LastAcion : null,
            player2LastAcion : null,
    ...
    handleBattleAction(playerId, action)
    {
        ...
        {
            battle.player1LastAcion = action;
        }
        else
        {
            battle.player2LastAcion = action;
        }
        //액션 처리 및 턴 넘기기
    ...
    processBattleAction(battle, attackerId, action)
    {
        ...
        switch (action)
        {
            ...
            case 'skill' :
                ...
                actionText `${actionText.name} 의 필살기 !`;
